...
export async function exportCanvasProjects(projects: CanvasProject[], fileName = "边缘幻星") {
    ...
    const data: CanvasExportFile = { app: "aivro", version: 3, exportedAt: new Date().toISOString(), projects: exportedProjects };
